...
train_data = pd.read_csv("C:/Users/alons/Desktop/Byjus/PRO-C117-Plantilla-Codigo-main/static/data_files/tweet_emotions.csv")    
training_sentences = []
...
# cargar modelo
model = load_model("C:/Users/alons/Desktop/Byjus/PRO-C117-Plantilla-Codigo-main/static/model_files/Tweet_Emotion.h5")
...
def predict(text):
    ...
    if text !="":
        ...
        padded=pad_sequences(
            sequences, max_length, padding=padding_type,truncating=trunc_type
        )
